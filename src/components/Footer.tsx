      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-3xl font-heading font-bold mb-6">{t("footer.company")}</h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xl font-heading font-semibold mb-6">{t("footer.quickLinks.title")}</h4>
        ...
        <div className="mt-12 pt-8 border-t border-white/20">
          <div className="max-w-md">
            <h4 className="text-xl font-heading font-semibold mb-4">{t("footer.newsletter.title")}</h4>
