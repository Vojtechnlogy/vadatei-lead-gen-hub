  ...
  return (
    <section className="py-24 bg-gradient-to-br from-corporate-light via-white to-gray-50" id="accomplishments">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="relative max-w-4xl mx-auto" style={{ minHeight: '280px' }}>
          {/* Navigation Arrows */}
          <Button
            variant="outline"
            size="icon"
          ...
          {/* Current Accomplishments (showing 2 at a time) */}
          <div className="grid lg:grid-cols-2 gap-8" style={{ minHeight: '280px' }}>
            {accomplishments.slice(currentIndex, currentIndex + 2).map((accomplishment, index) => {
              const IconComponent = accomplishment.icon;
              return (
                <div 
                  key={currentIndex + index}
                  className="bg-white rounded-xl p-8 shadow-card border border-gray-100 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 group flex flex-col animate-in slide-in-from-right-5 fade-in duration-700"
                  style={{ 
                    minHeight: '280px',
          ...
          {/* Carousel Indicators - 4 dots for 4 slides */}
