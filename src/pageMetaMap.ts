...
export const pages: PageMetaData[] = [
  {
    ...
    description: "70% of change efforts fail. We ensure you're in the winning 30%. Expert change management consulting with 30+ years experience. Start with our diagnostic deep-dive to discover the 5 hidden warning signs most leadership teams miss.",
