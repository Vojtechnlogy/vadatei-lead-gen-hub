    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none font-body">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-heading font-bold text-primary mb-4">⚠️ {t("services.extended-oversight.needsChecklist.title")}</h2>
            <ul className="space-y-3">
          ...
          <section className="mt-12 pt-8 border-t border-border">
            <div className="bg-primary/5 p-8 rounded-lg text-center">
              <h2 className="text-2xl font-heading font-bold text-primary mb-4">➡️ {t("services.extended-oversight.cta.title")}</h2>
