        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <section className="bg-gradient-to-r from-primary/5 to-primary/10 rounded-xl p-8">
              <h3 className="text-2xl font-heading font-semibold text-primary mb-6">
                Why Choose Our Diagnostic Approach?
              </h3>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  <Clock className="h-8 w-8 text-primary mx-auto mb-3" />
                  <h4 className="font-heading font-semibold text-gray-900 mb-2">Fast Results</h4>
                  <p className="text-sm text-muted-foreground">Actionable insights within 2-4 weeks</p>
                </div>
                <div className="text-center">
                  <Users className="h-8 w-8 text-primary mx-auto mb-3" />
                  <h4 className="font-heading font-semibold text-gray-900 mb-2">Expert Analysis</h4>
                  <p className="text-sm text-muted-foreground">30+ years of transformation experience</p>
                </div>
                <div className="text-center">
                  <Building className="h-8 w-8 text-primary mx-auto mb-3" />
                  <h4 className="font-heading font-semibold text-gray-900 mb-2">Proven Methods</h4>
                  <p className="text-sm text-muted-foreground">Evidence-based diagnostic framework</p>
                </div>
              </div>
            </section>
          </div>
            ...
            <Card className="shadow-lg">
              <CardContent className="p-8">
                <h3 className="text-2xl font-heading font-semibold text-primary mb-4">
                  {t("serviceModal.headings.diagnostic-deep-dive")}
                </h3>
